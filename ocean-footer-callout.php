...
final class Ocean_Footer_Callout {
	...
	public function updater() {
		...
		if( class_exists( 'OceanWP_Plugin_Updater' ) ) {
			$license	= new OceanWP_Plugin_Updater( __FILE__, 'Footer Callout', $this->version, 'OceanWP' );
		}
	}
	 ...
	 * @return Main Ocean_Footer_Callout instance
	 */
	...
	public function customize_register( $wp_customize ) {
	     ...
	     * Add a new section
	     */
        $wp_customize->add_section( 'ofc_section' , array(
		 ...
		 * Callout Template
		 */
		$wp_customize->add_setting( 'ofc_callout_template', array(
			'default'           	=> '0',
			'sanitize_callback' 	=> 'oceanwp_sanitize_select',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ofc_callout_template', array(
	     ...
	     * Callout text
	     */
        $wp_customize->add_setting( 'ofc_callout_text', array(
			'default'			=> 'Lorem ipsum dolor sit amet consectetur ni adipiscing elit.',
			'transport'			=> 'postMessage',
			'sanitize_callback' => 'wp_kses_post',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ofc_callout_text', array(
		 ...
		 */
		$wp_customize->add_setting( 'ofc_callout_text_typo_font_family', 	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field', ) );
		$wp_customize->add_setting( 'ofc_callout_text_typo_font_size',   	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field', ) );
		$wp_customize->add_setting( 'ofc_callout_text_typo_font_weight', 	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_key', ) );
		$wp_customize->add_setting( 'ofc_callout_text_typo_font_style',  	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_key', ) );
		$wp_customize->add_setting( 'ofc_callout_text_typo_transform', 		array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_key', ) );
		$wp_customize->add_setting( 'ofc_callout_text_typo_line_height', 	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field', ) );
		$wp_customize->add_setting( 'ofc_callout_text_typo_spacing', 		array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field', ) );

		$wp_customize->add_control( new OceanWP_Customizer_Typo_Control( $wp_customize, 'ofc_callout_text_typo', array(
	     ...
	     */
		$wp_customize->add_setting( 'ofc_callout_button_heading', array(
			'sanitize_callback' => 'wp_kses',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ofc_callout_button_heading', array(
	     ...
	     * Callout button
	     */
		$wp_customize->add_setting( 'ofc_callout_button', array(
			'default'			=> true,
			'sanitize_callback' => 'oceanwp_sanitize_checkbox',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ofc_callout_button', array(
	     ...
	     * Callout button
	     */
        $wp_customize->add_setting( 'ofc_callout_button_url', array(
			'default'			=> '#',
			'sanitize_callback' => 'esc_url_raw',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ofc_callout_button_url', array(
	     ...
	     * Callout button text
	     */
        $wp_customize->add_setting( 'ofc_callout_button_txt', array(
			'default'			=> esc_html__( 'Get In Touch', 'ocean-footer-callout' ),
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ofc_callout_button_txt', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_button_target', array(
			'default'			=> 'blank',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_select',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ofc_callout_button_target', array(
	     ...
	     * Callout button rel
	     */
        $wp_customize->add_setting( 'ofc_callout_button_rel', array(
			'default'			=> '',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_select',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ofc_callout_button_rel', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_button_classes', array(
			'sanitize_callback' => 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ofc_callout_button_classes', array(
		 ...
		 */
		$wp_customize->add_setting( 'ofc_callout_button_typo_font_family', 	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field', ) );
		$wp_customize->add_setting( 'ofc_callout_button_typo_font_size',   	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field', ) );
		$wp_customize->add_setting( 'ofc_callout_button_typo_font_weight', 	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_key', ) );
		$wp_customize->add_setting( 'ofc_callout_button_typo_font_style',  	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_key', ) );
		$wp_customize->add_setting( 'ofc_callout_button_typo_transform', 	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_key', ) );
		$wp_customize->add_setting( 'ofc_callout_button_typo_line_height', 	array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field', ) );
		$wp_customize->add_setting( 'ofc_callout_button_typo_spacing', 		array( 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field', ) );

		$wp_customize->add_control( new OceanWP_Customizer_Typo_Control( $wp_customize, 'ofc_callout_button_typo', array(
			'label'	   				=> esc_html__( 'Typography', 'ocean-footer-callout' ),
			'section'  				=> 'ofc_section',
            'settings'    			=> array(
	     ...
	     * Callout styling
	     */
		$wp_customize->add_setting( 'ofc_callout_styling_heading', array(
			'sanitize_callback' => 'wp_kses',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ofc_callout_styling_heading', array(
	     ...
	     * Callout padding
	     */
		$wp_customize->add_setting( 'ofc_callout_top_padding', array(
			'transport' 			=> 'postMessage',
			'default'				=> '30',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );
		$wp_customize->add_setting( 'ofc_callout_bottom_padding', array(
			'transport' 			=> 'postMessage',
			'default'				=> '30',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_setting( 'ofc_callout_tablet_top_padding', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number_blank',
		) );
		$wp_customize->add_setting( 'ofc_callout_tablet_bottom_padding', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number_blank',
		) );

		$wp_customize->add_setting( 'ofc_callout_mobile_top_padding', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number_blank',
		) );
		$wp_customize->add_setting( 'ofc_callout_mobile_bottom_padding', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number_blank',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Dimensions_Control( $wp_customize, 'ofc_callout_padding', array(
	     ...
	     * Callout background
	     */
        $wp_customize->add_setting( 'ofc_callout_bg', array(
			'default'			=> '#1b1b1b',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_bg', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_border', array(
			'default'			=> '#1b1b1b',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_border', array(
	     ...
	     * Callout color
	     */
        $wp_customize->add_setting( 'ofc_callout_color', array(
			'default'			=> '#dddddd',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_color', array(
	     ...
	     * Callout links color
	     */
        $wp_customize->add_setting( 'ofc_callout_links_color', array(
			'default'			=> '#ffffff',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_links_color', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_links_color_hover', array(
			'default'			=> '#13aff0',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_links_color_hover', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_button_border_radius', array(
			'default'			=> '30',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'ofc_callout_button_border_radius', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_button_bg', array(
			'default'			=> '#13aff0',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_button_bg', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_button_color', array(
			'default'			=> '#ffffff',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_button_color', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_button_hover_bg', array(
			'default'			=> '#0b7cac',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_button_hover_bg', array(
	     ...
	     */
        $wp_customize->add_setting( 'ofc_callout_button_hover_color', array(
			'default'			=> '#ffffff',
			'transport' 		=> 'postMessage',
			'sanitize_callback' => 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ofc_callout_button_hover_color', array(
	...
	public function customize_preview_js() {
		...
		wp_localize_script( 'ofc-customizer', 'ofc_callout', array(
